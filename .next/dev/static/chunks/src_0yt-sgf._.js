...
function LiveMap({ credentials }) {
    ...
    const { basemapId: active, projection, weatherOn, weatherMode, weatherOpacity: radarOpacity, setBasemapId: setActive, setProjection, setWeatherOn, setWeatherMode, setWeatherOpacity: setRadarOpacity } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$settings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSettings"])();
    ...
    const { frames: radarFrames, pastCount } = (()=>{
        if (weatherMode === "clouds") {
            ...
            for(let i = CLOUDS_DAYS_BACK; i >= 1; i -= 1){
                ...
                all.push({
                    ...
                    url: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gibs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gibsTileUrl"])({
        ...
        const past = weatherMaps.radarPast.map((f)=>({
                time: f.time,
                url: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$weather$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["radarTileUrl"])({
                    host: weatherMaps.host,
                    path: f.path,
                    color: 2
                })
            }));
        const fcast = weatherMaps.radarNowcast.map((f)=>({
                time: f.time,
                url: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$weather$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["radarTileUrl"])({
                    host: weatherMaps.host,
                    path: f.path,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LiveMap.useEffect": ()=>{
            ...
            const interval = weatherMode === "clouds" ? CLOUDS_ANIM_INTERVAL_MS : ANIM_INTERVAL_MS;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LiveMap.useEffect": ()=>{
            ...
            const urls = radarFrames.map({
                "LiveMap.useEffect.urls": (f)=>f.url
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(WeatherPanel, {
                        ...
                        onModeChange: (m)=>{
                            setWeatherMode(m);
                            const newCount = m === "radar" ? weatherMaps?.radarPast.length ?? 0 : CLOUDS_DAYS_BACK;
                            setRadarFrameIndex(Math.max(0, newCount - 1));
                        },
                        frames: radarFrames,
...
_s(LiveMap, "I7TB+Ts04KuzYJN1GrQJQNw+WkU=", false, function() {
    return [
            ...
            enabled && frames.length > 0 && currentFrame && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: mode === "clouds" ? new Date(currentFrame.time * 1000).toLocaleDateString([], {
                                    year: "numeric",
                                    month: "short",
                                    day: "numeric"
                    ...
                    mode === "radar" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "text-[10px] text-neutral-500",
                        children: "RainViewer · national radar networks · gaps over oceans"
                    }, void 0, false, {
                        fileName: "[project]/src/components/Map.tsx",
                        lineNumber: 720,
                        columnNumber: 13
                    ...
                    mode === "clouds" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "text-[10px] text-neutral-500",
                        children: "NASA GIBS · MODIS Terra true-color · daily, global"
                    }, void 0, false, {
                        fileName: "[project]/src/components/Map.tsx",
                        lineNumber: 725,
                        columnNumber: 13
...
//# sourceMappingURL=src_0yt-sgf._.js.map